...
// Mismo criterio que la cookie de sesión (ver `lib/auth/jwt.js`).
export const MICROSOFT_STATE_COOKIE =
  process.env.NODE_ENV === 'production' ? '__Host-ms_oauth_state' : 'ms_oauth_state';
